  ...
  return (
    <DropdownMenu open={open}>
      <DropdownMenuTrigger asChild>
        <Button
          className="!justify-start space-x-2 !px-3 focus:outline-none md:w-full"
          variant={"ghost"}
          size={"lg"}
      ...
      <DropdownMenuContent
        ref={ref}
        className={cn(
          "w-64 !rounded-xl !p-0 transition-opacity dark:bg-neutral-900",
          !open && "opacity-0",
        )}
        align="end"
        alignOffset={-40}
      >
        ...
        {showModeToggle && (
          <>
            <div className=" flex items-center border-b border-gray-200 px-2 py-3 dark:border-neutral-800">
              <ChevronLeft
                size={18}
            ...
            <Label htmlFor="dark-mode" className="menuItem">
              ...
              <DropdownMenuItem className="ml-auto !p-0">
                <Switch
                  id="dark-mode"
                  className="ml-auto focus:bg-transparent"
                  checked={theme === "dark"}
